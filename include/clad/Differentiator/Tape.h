...
private:
  ...
  template <typename ElTy> CUDA_HOST_DEVICE void destroy_element(ElTy* elem) { elem->~ElTy(); }

  template <typename ElTy, size_t N> CUDA_HOST_DEVICE void destroy_element(ElTy (*arr)[N]) {
