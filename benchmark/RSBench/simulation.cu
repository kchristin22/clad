...
__attribute__((device)) void calculate_sig_T_pullback(int nuc, double E, Input input, const double *pseudo_K0RS, RSComplex *sigTfactors, int *_d_nuc, double *_d_E, Input *_d_input, double *_d_pseudo_K0RS, RSComplex *_d_sigTfactors) {
    int _d_i = 0;
    int i = 0;
    ...
    for (;; _t0--) {
        ...
        i--;
        {
            ...
            double _r7 = 0.;
            _r7 += -_r_d6 * clad::custom_derivatives::sin_pushforward(phi, 1.).pushforward;
            _d_phi += _r7;
        }
        {
            ...
            double _r6 = 0.;
            _r6 += _r_d5 * clad::custom_derivatives::cos_pushforward(phi, 1.).pushforward;
            _d_phi += _r6;
        }
        {
            phi = clad::pop(_t8);
        ...
        }
        {
            if (clad::back(_cond0)) {
                ...
                double _r_d1 = _d_phi;
                double _r1 = 0.;
                _r1 += _r_d1 * clad::custom_derivatives::atan_pushforward(phi, 1.).pushforward;
                _d_phi += _r1;
            } else {
                if (clad::back(_cond1)) {
                    phi = clad::pop(_t4);
                    double _r_d2 = _d_phi;
                    double _r2 = 0.;
                    _r2 += -_r_d2 * clad::custom_derivatives::atan_pushforward(3. * phi / clad::push(_t5, (3. - phi * phi)), 1.).pushforward;
                    ...
                    if (clad::back(_cond2)) {
                        ...
                        double _r_d3 = _d_phi;
                        double _r4 = 0.;
                        _r4 += -_r_d3 * clad::custom_derivatives::atan_pushforward(phi * (15. - phi * phi) / clad::push(_t7, (15. - 6. * phi * phi)), 1.).pushforward;
        ...
        }
        {
            ...
            double _r_d0 = _d_phi;
            _d_phi = 0.;
            _d_pseudo_K0RS[nuc * input.numL + i] += _r_d0 * clad::pop(_t2);
            double _r0 = 0.;
            _r0 += pseudo_K0RS[nuc * input.numL + i] * _r_d0 * clad::custom_derivatives::sqrt_pushforward(E, 1.).pushforward;
            *_d_E += _r0;
        }
    }
}
__host__ __device__ static inline constexpr void constructor_pullback(RSComplex &&arg, RSComplex *_d_this, RSComplex *_d_arg) noexcept;
__attribute__((host)) __attribute__((device)) void c_mul_pullback(RSComplex A, RSComplex B, RSComplex _d_y, RSComplex *_d_A, RSComplex *_d_B) {
    ...
    C.r = (a * c) - (b * d);
    C.i = (a * d) + (b * c);
    ::constructor_pullback(std::move(C), &_d_y, &_d_C);
    {
        double _r_d1 = _d_C.i;
        _d_C.i = 0.;
        _d_a += _r_d1 * d;
...
__attribute__((device)) void c_abs_pullback(RSComplex A, double _d_y, RSComplex *_d_A) {
    {
        double _r0 = 0.;
        _r0 += _d_y * clad::custom_derivatives::sqrt_pushforward(A.r * A.r + A.i * A.i, 1.).pushforward;
        (*_d_A).r += _r0 * A.r;
        (*_d_A).r += A.r * _r0;
        (*_d_A).i += _r0 * A.i;
        (*_d_A).i += A.i * _r0;
...
__attribute__((device)) void fast_exp_pullback(double x, double _d_y, double *_d_x) {
    x = 1. + x * 2.44140625E-4;
    double _t0 = x;
    x *= x;
    double _t1 = x;
...
__attribute__((device)) void fast_cexp_pullback(RSComplex z, RSComplex _d_y, RSComplex *_d_z) {
    ...
    RSComplex result = c_mul(t5, t4);
    ::constructor_pullback(std::move(result), &_d_y, &_d_result);
    {
        RSComplex _r3 = {0., 0.};
        RSComplex _r4 = {0., 0.};
    ...
    {
        double _r2 = 0.;
        _r2 += _d_t3 * clad::custom_derivatives::sin_pushforward(y, 1.).pushforward;
        _d_y0 += _r2;
    }
    {
        double _r1 = 0.;
        _r1 += _d_t2 * clad::custom_derivatives::cos_pushforward(y, 1.).pushforward;
        _d_y0 += _r1;
    }
    {
        double _r0 = 0.;
...
inline constexpr void operator_equal_pullback(RSComplex &this_1,RSComplex &&arg, RSComplex _d_y, RSComplex *_d_this, RSComplex *_d_arg) noexcept {
    double _t0 = this_1.r;
    this_1.r = arg.r;
    double _t1 = this_1.i;
    this_1.i = arg.i;
...
inline constexpr clad::ValueAndAdjoint<RSComplex &, RSComplex &> operator_equal_forw(RSComplex &this_1, RSComplex &&arg, RSComplex *_d_this, RSComplex &&_d_arg) noexcept;
__attribute__((always_inline)) __attribute__((device)) void fast_nuclear_W_pullback(RSComplex Z, RSComplex _d_y, RSComplex *_d_Z) {
    ...
    RSComplex W0 = {0., 0.};
    {
        ...
        if (_cond0) {
            ...
            for (n = 0; ; n++) {
                ...
                clad::push(_t2, std::move(top)) , top = c_sub(c_mul(t3, fast_cexp(c_mul(t1, Z))), one);
                clad::push(_t3, std::move(t4)) , t4 = {denominator_left[n], 0};
                clad::push(_t4, std::move(t5)) , t5 = {144, 0};
                clad::push(_t5, std::move(bot)) , bot = c_sub(t4, c_mul(t5, c_mul(Z, Z)));
                clad::push(_t6, std::move(t6)) , t6 = {an[n], 0};
                clad::push(_t7, sum);
                clad::ValueAndAdjoint<RSComplex &, RSComplex &> _t8 = operator_equal_forw(sum, c_add(sum, c_mul(t6, c_div(top, bot))), &_d_sum, {0., 0.});
            }
            _t9 = W;
            clad::ValueAndAdjoint<RSComplex &, RSComplex &> _t10 = operator_equal_forw(W, c_add(W, c_mul(prefactor, c_mul(Z, sum))), &_d_W, {0., 0.});
            goto _label0;
        } else {
    ...
    if (_cond0) {
      _label0:
        ::constructor_pullback(std::move(W), &_d_y, &_d_W);
        {
            RSComplex _r31 = {0., 0.};
            W = _t9;
        ...
        }
        {
            ...
            clad::custom_derivatives::class_functions::constructor_pullback(i, &_r1, &_d_i);
            RSComplex _r3 = {0., 0.};
            RSComplex _r4 = {0., 0.};
            c_sub_pullback(one, fast_cexp(c_mul(t1, Z)), _r2, &_r3, &_r4);
            clad::custom_derivatives::class_functions::constructor_pullback(one, &_r3, &_d_one);
            RSComplex _r5 = {0., 0.};
      ...
      _label1:
        ::constructor_pullback(std::move(W0), &_d_y, &_d_W0);
        {
            RSComplex _r40 = {0., 0.};
            RSComplex _r43 = {0., 0.};
...
__host__ __device__ static inline constexpr void constructor_pullback(const Window &arg, Window *_d_this, Window *_d_arg) noexcept;
__attribute__((always_inline)) __attribute__((device)) void calculate_micro_xs_doppler_pullback(double *micro_xs, int nuc, double E, Input input, const int *n_windows, const double *pseudo_K0RS, const Window *windows, Pole *poles, int max_num_windows, int max_num_poles, double *_d_micro_xs, int *_d_nuc, double *_d_E, Input *_d_input, int *_d_n_windows, double *_d_pseudo_K0RS, Window *_d_windows, Pole *_d_poles, int *_d_max_num_windows, int *_d_max_num_poles) {
    bool _cond0;
    int _d_i = 0;
    int i = 0;
    clad::tape<Pole> _t1 = {};
    ...
    for (i = w.start; ; i++) {
        ...
        clad::push(_t4, std::move(Z)) , Z = c_mul(c_sub(E_c, pole.MP_EA), dopp_c);
        clad::push(_t5, std::move(faddeeva)) , faddeeva = fast_nuclear_W(Z);
        clad::push(_t6, std::move(_t10)) , _t10 = c_mul(pole.MP_RT, c_mul(faddeeva, sigTfactors[pole.l_value]));
        sigT += _t10.r;
        clad::push(_t7, std::move(_t20)) , _t20 = c_mul(pole.MP_RA, faddeeva);
        sigA += _t20.r;
        clad::push(_t8, std::move(_t30)) , _t30 = c_mul(pole.MP_RF, faddeeva);
        sigF += _t30.r;
    }
    sigE = sigT - sigA;
    micro_xs[0] = sigT;
    ...
    }
    {
        for (;; _t0--) {
            ...
            }
            {
                RSComplex _r16 = {0., 0.};
                RSComplex _r17 = {0., 0.};
                c_mul_pullback(pole.MP_RF, faddeeva, _d__t3, &_r16, &_r17);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_RF, &_r16, &_d_pole.MP_RF);
                clad::custom_derivatives::class_functions::constructor_pullback(faddeeva, &_r17, &_d_faddeeva);
                _d__t3 = {0., 0.};
                _t30 = clad::pop(_t8);
            }
            {
            ...
            }
            {
                RSComplex _r14 = {0., 0.};
                RSComplex _r15 = {0., 0.};
                c_mul_pullback(pole.MP_RA, faddeeva, _d__t2, &_r14, &_r15);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_RA, &_r14, &_d_pole.MP_RA);
                clad::custom_derivatives::class_functions::constructor_pullback(faddeeva, &_r15, &_d_faddeeva);
                _d__t2 = {0., 0.};
                _t20 = clad::pop(_t7);
            }
            {
            ...
            }
            {
                RSComplex _r10 = {0., 0.};
                RSComplex _r11 = {0., 0.};
                c_mul_pullback(pole.MP_RT, c_mul(faddeeva, sigTfactors[pole.l_value]), _d__t1, &_r10, &_r11);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_RT, &_r10, &_d_pole.MP_RT);
                RSComplex _r12 = {0., 0.};
                RSComplex _r13 = {0., 0.};
                c_mul_pullback(faddeeva, sigTfactors[pole.l_value], _r11, &_r12, &_r13);
                clad::custom_derivatives::class_functions::constructor_pullback(faddeeva, &_r12, &_d_faddeeva);
                clad::custom_derivatives::class_functions::constructor_pullback(sigTfactors[pole.l_value], &_r13, &_d_sigTfactors[pole.l_value]);
                _d__t1 = {0., 0.};
                _t10 = clad::pop(_t6);
            }
            {
                ...
                clad::custom_derivatives::class_functions::constructor_pullback(Z, &_r9, &_d_Z);
                _d_faddeeva = {0., 0.};
            ...
            }
            {
                RSComplex _r5 = {0., 0.};
                RSComplex _r8 = {0., 0.};
                c_mul_pullback(c_sub(E_c, pole.MP_EA), dopp_c, _d_Z, &_r5, &_r8);
                RSComplex _r6 = {0., 0.};
                RSComplex _r7 = {0., 0.};
                c_sub_pullback(E_c, pole.MP_EA, _r5, &_r6, &_r7);
                clad::custom_derivatives::class_functions::constructor_pullback(E_c, &_r6, &_d_E_c);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_EA, &_r7, &_d_pole.MP_EA);
                clad::custom_derivatives::class_functions::constructor_pullback(dopp_c, &_r8, &_d_dopp_c);
                _d_Z = {0., 0.};
                Z = clad::pop(_t4);
            }
            {
    ...
    ::constructor_pullback(windows[nuc * max_num_windows + window], &_d_w, &_d_windows[nuc * max_num_windows + window]);
    {
        int _r2 = 0;
        double _r3 = 0.;
        Input _r4 = {0, 0, 0, static_cast<HM_size>(0), 0, 0, 0, 0, 0, 0, 0};
        calculate_sig_T_pullback(nuc, E, input, pseudo_K0RS, sigTfactors, &_r2, &_r3, &_r4, _d_pseudo_K0RS, _d_sigTfactors);
        *_d_nuc += _r2;
        *_d_E += _r3;
        clad::custom_derivatives::class_functions::constructor_pullback(input, &_r4, &(*_d_input));
    }
    {
...
__attribute__((always_inline)) __attribute__((device)) void calculate_micro_xs_pullback(double *micro_xs, int nuc, double E, Input input, const int *n_windows, const double *pseudo_K0RS, const Window *windows, Pole *poles, int max_num_windows, int max_num_poles, double *_d_micro_xs, int *_d_nuc, double *_d_E, Input *_d_input, int *_d_n_windows, double *_d_pseudo_K0RS, Window *_d_windows, Pole *_d_poles, int *_d_max_num_windows, int *_d_max_num_poles) {
    ...
    for (i = w.start; ; i++) {
        ...
        clad::ValueAndAdjoint<RSComplex &, RSComplex &> _t7 = operator_equal_forw(PSIIKI, c_div(t1, c_sub(pole.MP_EA, t2)), &_d_PSIIKI, {0., 0.});
        clad::push(_t8, std::move(E_c)) , E_c = {E, 0};
        clad::push(_t9, CDUM);
        clad::ValueAndAdjoint<RSComplex &, RSComplex &> _t10 = operator_equal_forw(CDUM, c_div(PSIIKI, E_c), &_d_CDUM, {0., 0.});
        clad::push(_t12, std::move(_t11)) , _t11 = c_mul(pole.MP_RT, c_mul(CDUM, sigTfactors[pole.l_value]));
        sigT += _t11.r;
        clad::push(_t13, std::move(_t20)) , _t20 = c_mul(pole.MP_RA, CDUM);
        sigA += _t20.r;
        clad::push(_t14, std::move(_t30)) , _t30 = c_mul(pole.MP_RF, CDUM);
        sigF += _t30.r;
    }
    sigE = sigT - sigA;
    micro_xs[0] = sigT;
    ...
    }
    {
        for (;; _t0--) {
            ...
            }
            {
                RSComplex _r20 = {0., 0.};
                RSComplex _r21 = {0., 0.};
                c_mul_pullback(pole.MP_RF, CDUM, _d__t3, &_r20, &_r21);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_RF, &_r20, &_d_pole.MP_RF);
                clad::custom_derivatives::class_functions::constructor_pullback(CDUM, &_r21, &_d_CDUM);
                _d__t3 = {0., 0.};
                _t30 = clad::pop(_t14);
            }
            {
            ...
            }
            {
                RSComplex _r18 = {0., 0.};
                RSComplex _r19 = {0., 0.};
                c_mul_pullback(pole.MP_RA, CDUM, _d__t2, &_r18, &_r19);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_RA, &_r18, &_d_pole.MP_RA);
                clad::custom_derivatives::class_functions::constructor_pullback(CDUM, &_r19, &_d_CDUM);
                _d__t2 = {0., 0.};
                _t20 = clad::pop(_t13);
            }
            {
            ...
            }
            {
                RSComplex _r14 = {0., 0.};
                RSComplex _r15 = {0., 0.};
                c_mul_pullback(pole.MP_RT, c_mul(CDUM, sigTfactors[pole.l_value]), _d__t1, &_r14, &_r15);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_RT, &_r14, &_d_pole.MP_RT);
                RSComplex _r16 = {0., 0.};
                RSComplex _r17 = {0., 0.};
                c_mul_pullback(CDUM, sigTfactors[pole.l_value], _r15, &_r16, &_r17);
                clad::custom_derivatives::class_functions::constructor_pullback(CDUM, &_r16, &_d_CDUM);
                clad::custom_derivatives::class_functions::constructor_pullback(sigTfactors[pole.l_value], &_r17, &_d_sigTfactors[pole.l_value]);
                _d__t1 = {0., 0.};
                _t11 = clad::pop(_t12);
            }
            {
                RSComplex _r11 = {0., 0.};
                CDUM = clad::back(_t9);
                operator_equal_pullback(CDUM, c_div(PSIIKI, E_c), {0., 0.}, &_d_CDUM, &_r11);
                RSComplex _r12 = {0., 0.};
                RSComplex _r13 = {0., 0.};
                c_div_pullback(PSIIKI, E_c, _r11, &_r12, &_r13);
                clad::custom_derivatives::class_functions::constructor_pullback(PSIIKI, &_r12, &_d_PSIIKI);
                clad::custom_derivatives::class_functions::constructor_pullback(E_c, &_r13, &_d_E_c);
                clad::pop(_t9);
            }
            {
                *_d_E += _d_E_c.r;
            ...
            }
            {
                ...
                operator_equal_pullback(PSIIKI, c_div(t1, c_sub(pole.MP_EA, t2)), {0., 0.}, &_d_PSIIKI, &_r6);
                RSComplex _r7 = {0., 0.};
                RSComplex _r8 = {0., 0.};
                c_div_pullback(t1, c_sub(pole.MP_EA, t2), _r6, &_r7, &_r8);
                clad::custom_derivatives::class_functions::constructor_pullback(t1, &_r7, &_d_t1);
                RSComplex _r9 = {0., 0.};
                RSComplex _r10 = {0., 0.};
                c_sub_pullback(pole.MP_EA, t2, _r8, &_r9, &_r10);
                clad::custom_derivatives::class_functions::constructor_pullback(pole.MP_EA, &_r9, &_d_pole.MP_EA);
                clad::custom_derivatives::class_functions::constructor_pullback(t2, &_r10, &_d_t2);
                clad::pop(_t6);
            }
            {
                double _r5 = 0.;
                _r5 += _d_t2.r * clad::custom_derivatives::sqrt_pushforward(E, 1.).pushforward;
                *_d_E += _r5;
                _d_t2 = {0., 0.};
                t2 = clad::pop(_t5);
            }
...
__attribute__((always_inline)) __attribute__((device)) void calculate_micro_xs_doppler_pullback(double *micro_xs, int nuc, double E, Input input, const int *n_windows, const double *pseudo_K0RS, const Window *windows, Pole *poles, int max_num_windows, int max_num_poles, double *_d_micro_xs, int *_d_nuc, double *_d_E, Input *_d_input, Pole *_d_poles, int *_d_max_num_windows, int *_d_max_num_poles);
__attribute__((always_inline)) __attribute__((device)) void calculate_micro_xs_pullback(double *micro_xs, int nuc, double E, Input input, const int *n_windows, const double *pseudo_K0RS, const Window *windows, Pole *poles, int max_num_windows, int max_num_poles, double *_d_micro_xs, int *_d_nuc, double *_d_E, Input *_d_input, Pole *_d_poles, int *_d_max_num_windows, int *_d_max_num_poles);
__attribute__((device)) void calculate_macro_xs_grad_0_11(double *__restrict macro_xs, int mat, double E, Input input, const int *__restrict num_nucs, const int *__restrict mats, int max_num_nucs, const double *__restrict concs, const int *__restrict n_windows, const double *__restrict pseudo_K0Rs, const Window *__restrict windows, Pole *__restrict poles, int max_num_windows, int max_num_poles, double *_d_macro_xs, Pole *_d_poles) {
    int _d_mat = 0;
    double _d_E = 0.;
    Input _d_input = {0, 0, 0, static_cast<HM_size>(0), 0, 0, 0, 0, 0, 0, 0};
    ...
    for (i = 0; ; i++) {
        ...
        _t0++;
        clad::push(_t1, nuc) , nuc = mats[mat * max_num_nucs + i];
        {
        ...
        for (clad::push(_t3, j) , j = 0; ; j++) {
            ...
            macro_xs[j] += clad::back(_t4) * concs[mat * max_num_nucs + i];
        }
    }
    for (;; _t0--) {
        {
        ...
        }
        {
            if (clad::back(_cond0)) {
                int _r0 = 0;
                double _r1 = 0.;
                Input _r2 = {0, 0, 0, static_cast<HM_size>(0), 0, 0, 0, 0, 0, 0, 0};
                int _r3 = 0;
                int _r4 = 0;
                calculate_micro_xs_doppler_pullback(micro_xs, nuc, E, input, n_windows, pseudo_K0Rs, windows, poles, max_num_windows, max_num_poles, _d_micro_xs, &_r0, &_r1, &_r2, _d_poles, &_r3, &_r4);
                _d_nuc += _r0;
                _d_E += _r1;
                clad::custom_derivatives::class_functions::constructor_pullback(input, &_r2, &_d_input);
                _d_max_num_windows += _r3;
                _d_max_num_poles += _r4;
            } else {
                int _r5 = 0;
                double _r6 = 0.;
                Input _r7 = {0, 0, 0, static_cast<HM_size>(0), 0, 0, 0, 0, 0, 0, 0};
                int _r8 = 0;
                int _r9 = 0;
                calculate_micro_xs_pullback(micro_xs, nuc, E, input, n_windows, pseudo_K0Rs, windows, poles, max_num_windows, max_num_poles, _d_micro_xs, &_r5, &_r6, &_r7, _d_poles, &_r8, &_r9);
                _d_nuc += _r5;
                _d_E += _r6;
                clad::custom_derivatives::class_functions::constructor_pullback(input, &_r7, &_d_input);
...
__attribute__((device)) void calculate_sig_T_pullback(int nuc, double E, Input input, const double *pseudo_K0RS, RSComplex *sigTfactors, int *_d_nuc, double *_d_E, Input *_d_input, RSComplex *_d_sigTfactors){};
__host__ __device__ static inline constexpr void constructor_pullback(const Window &arg, Window *_d_this) noexcept{};
__attribute__((always_inline)) __attribute__((device)) void calculate_micro_xs_doppler_pullback(double *micro_xs, int nuc, double E, Input input, const int *n_windows, const double *pseudo_K0RS, const Window *windows, Pole *poles, int max_num_windows, int max_num_poles, double *_d_micro_xs, int *_d_nuc, double *_d_E, Input *_d_input, Pole *_d_poles, int *_d_max_num_windows, int *_d_max_num_poles) {
    bool _cond0;
    int _d_i = 0;
    int i = 0;
    ...
    ::constructor_pullback(windows[nuc * max_num_windows + window], &_d_w);
    {
        int _r2 = 0;
        double _r3 = 0.;
        Input _r4 = {0, 0, 0, static_cast<HM_size>(0), 0, 0, 0, 0, 0, 0, 0};
        calculate_sig_T_pullback(nuc, E, input, pseudo_K0RS, sigTfactors, &_r2, &_r3, &_r4, _d_sigTfactors);
        *_d_nuc += _r2;
        *_d_E += _r3;
        clad::custom_derivatives::class_functions::constructor_pullback(input, &_r4, &(*_d_input));
    }
