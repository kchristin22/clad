...
__attribute__((always_inline)) __attribute__((device)) void
calculate_micro_xs_doppler_pullback(
    double *micro_xs, int nuc, double E, Input input, const int *n_windows,
    const double *pseudo_K0RS, const Window *windows, Pole *poles,
    int max_num_windows, int max_num_poles, double *_d_micro_xs, int *_d_nuc,
    double *_d_E, Pole *_d_poles, int *_d_max_num_windows,
    int *_d_max_num_poles);
__attribute__((always_inline)) __attribute__((device)) void
calculate_micro_xs_pullback(double *micro_xs, int nuc, double E, Input input,
                            const int *n_windows, const double *pseudo_K0RS,
                            const Window *windows, Pole *poles,
                            int max_num_windows, int max_num_poles,
                            double *_d_micro_xs, int *_d_nuc, double *_d_E,
                            Pole *_d_poles, int *_d_max_num_windows,
                            int *_d_max_num_poles);
__attribute__((device)) void calculate_macro_xs_grad_0_11(
    ...
    int max_num_windows, int max_num_poles, double *_d_macro_xs, Pole *_d_poles)
{
    int _d_mat = 0;
    double _d_E = 0.;
        ...
        }
        {
            ...
            else
            {
                ...
                calculate_micro_xs_pullback(
                    micro_xs, nuc, E, input, n_windows, pseudo_K0Rs, windows,
                    poles, max_num_windows, max_num_poles, _d_micro_xs, &_r4,
                    &_r5, _d_poles, &_r6, &_r7);
                _d_nuc += _r4;
                _d_E += _r5;
...
calculate_sig_T_pullback(int nuc, double E, Input input,
                         const double *pseudo_K0RS, RSComplex *sigTfactors,
                         int *_d_nuc, double *_d_E, RSComplex *_d_sigTfactors);
__attribute__((device)) void c_sub_pullback(RSComplex A, RSComplex B,
                                            RSComplex _d_y, RSComplex *_d_A,
                                            RSComplex *_d_B);
__attribute__((host)) __attribute__((device)) void
c_mul_pullback(RSComplex A, RSComplex B, RSComplex _d_y, RSComplex *_d_A,
               RSComplex *_d_B);
__attribute__((always_inline)) __attribute__((device)) void
fast_nuclear_W_pullback(RSComplex Z, RSComplex _d_y, RSComplex *_d_Z);
__attribute__((always_inline)) __attribute__((device)) void
calculate_micro_xs_doppler_pullback(
    double *micro_xs, int nuc, double E, Input input, const int *n_windows,
    const double *pseudo_K0RS, const Window *windows, Pole *poles,
    ...
    for (;; _t0--)
    {
        ...
        }
        {
            ...
            clad::custom_derivatives::class_functions::constructor_pullback(
                pole.MP_RF, &_r15, &_d_pole.MP_RF);
            clad::custom_derivatives::class_functions::constructor_pullback(
                faddeeva, &_r16, &_d_faddeeva);
            _d__t3 = {0., 0.};
            _t30 = clad::pop(_t8);
        }
        {
        ...
        }
        {
            ...
            clad::custom_derivatives::class_functions::constructor_pullback(
                pole.MP_RA, &_r13, &_d_pole.MP_RA);
            clad::custom_derivatives::class_functions::constructor_pullback(
                faddeeva, &_r14, &_d_faddeeva);
            _d__t2 = {0., 0.};
            _t20 = clad::pop(_t7);
        }
        {
        ...
        }
        {
            RSComplex _r9 = {0., 0.};
            RSComplex _r10 = {0., 0.};
            c_mul_pullback(pole.MP_RT,
                           c_mul(faddeeva, sigTfactors[pole.l_value]), _d__t1,
                           &_r9, &_r10);
            clad::custom_derivatives::class_functions::constructor_pullback(
                pole.MP_RT, &_r9, &_d_pole.MP_RT);
            RSComplex _r11 = {0., 0.};
            RSComplex _r12 = {0., 0.};
            c_mul_pullback(faddeeva, sigTfactors[pole.l_value], _r10, &_r11,
                           &_r12);
            clad::custom_derivatives::class_functions::constructor_pullback(
                faddeeva, &_r11, &_d_faddeeva);
            clad::custom_derivatives::class_functions::constructor_pullback(
                sigTfactors[pole.l_value], &_r12,
                &_d_sigTfactors[pole.l_value]);
            _d__t1 = {0., 0.};
            _t10 = clad::pop(_t6);
        }
        {
        ...
        }
        {
            ...
            clad::custom_derivatives::class_functions::constructor_pullback(
                E_c, &_r5, &_d_E_c);
            clad::custom_derivatives::class_functions::constructor_pullback(
                pole.MP_EA, &_r6, &_d_pole.MP_EA);
            clad::custom_derivatives::class_functions::constructor_pullback(
                dopp_c, &_r7, &_d_dopp_c);
            _d_Z = {0., 0.};
            Z = clad::pop(_t4);
        }
        {
        ...
        {
            clad::custom_derivatives::class_functions::constructor_pullback(
                poles[nuc * max_num_poles + i], &_d_pole,
                &_d_poles[nuc * max_num_poles + i]);
...
__attribute__((device)) void c_div_pullback(RSComplex A, RSComplex B,
                                            RSComplex _d_y, RSComplex *_d_A,
                                            RSComplex *_d_B);
__attribute__((device)) inline constexpr void
operator_equal_pullback(RSComplex &this_1, RSComplex &&arg, RSComplex _d_y,
                        RSComplex *_d_this, RSComplex *_d_arg) noexcept;
__attribute__((
    device)) inline constexpr clad::ValueAndAdjoint<RSComplex &, RSComplex &>
                            ...
                            int *_d_max_num_poles)
{
    ...
    for (;; _t0--)
    {
        ...
        }
        {
            RSComplex _r13 = {0., 0.};
            RSComplex _r14 = {0., 0.};
            c_mul_pullback(pole.MP_RT, c_mul(CDUM, sigTfactors[pole.l_value]),
                           _d__t1, &_r13, &_r14);
            clad::custom_derivatives::class_functions::constructor_pullback(
                pole.MP_RT, &_r13, &_d_pole.MP_RT);
            RSComplex _r15 = {0., 0.};
            RSComplex _r16 = {0., 0.};
        ...
        }
        {
            ...
            operator_equal_pullback(clad::back(_t6),
                                    c_div(t1, c_sub(pole.MP_EA, t2)), {0., 0.},
                                    &_d_PSIIKI, &_r5);
            RSComplex _r6 = {0., 0.};
            RSComplex _r7 = {0., 0.};
...
__device__ __host__ static inline constexpr void
...
__attribute__((device)) void fast_cexp_pullback(RSComplex z, RSComplex _d_y,
                                                RSComplex *_d_z);
__attribute__((device)) void c_add_pullback(RSComplex A, RSComplex B,
                                            RSComplex _d_y, RSComplex *_d_A,
                                            RSComplex *_d_B);
__attribute__((always_inline)) __attribute__((device)) void
fast_nuclear_W_pullback(RSComplex Z, RSComplex _d_y, RSComplex *_d_Z)
...
__attribute__((device)) __attribute__((host)) static inline constexpr void
constructor_pullback(RSComplex &&arg, RSComplex *_d_this,
                     RSComplex *_d_arg) noexcept
{
    {
...
__attribute__((device)) void fast_exp_pullback(double x, double _d_y,
                                               double *_d_x);
__attribute__((device)) void fast_cexp_pullback(RSComplex z, RSComplex _d_y,
                                                RSComplex *_d_z)
{
...
__global__ void xs_lookup_kernel_baseline(Input in, SimulationData GSD )
{
    ...
    calculate_macro_xs_grad_0_11(macro_xs, mat, E, in, GSD.num_nucs, GSD.mats, GSD.max_num_nucs,
